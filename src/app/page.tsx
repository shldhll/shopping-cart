          ...
          <table className="w-[90%] font-light">
            <thead>
              <tr>
                ...
                <th className="uppercase font-light text-xs text-gray-400 text-center">Quantity</th>
                <th className="uppercase font-light text-xs text-gray-400 text-center">Price</th>
                <th className="uppercase font-light text-xs text-gray-400 text-center">Total</th>
              </tr>
            </thead>
            <tbody>
              {
                products.map((product: IProduct) => (
                  <tr key={product.code}>
                    ...
                    <td className="text-center pt-8">1</td>
                    <td className="text-center pt-8">{product.price} €</td>
                    <td className="text-center pt-8">0 €</td> {/* TODO: calculate total price */}
                  </tr>
                ))
              }
            </tbody>
